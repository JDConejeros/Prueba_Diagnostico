---
title: "Prueba de diagnóstico DCPP"
format: html
theme-settings: 
  theme: cosmo
  barcolor: "#2C7FB8"
  barposition: top
  footer-center: 'Diplomado en Ciencia de Datos para Políticas Públicas'
survey-settings:
  show-previous: true
  all-required: true
  auto-scroll: false
  ...
  suffled: 
    ...
    - q06_estadistica
    - q09_estadistica
    - q07_politicas_publicas
    - q10_politicas_publicas
    - q01_programacion
    - q02_programacion
    - q03_programacion
    - q08_programacion
...
# Prueba de diagnóstico DCPP

Esta prueba tiene como objetivo evaluar el nivel de conocimiento inicial de cada estudiante en tres dimensiones de interés para el diplomado: estadística, programación y políticas públicas. 

Esta prueba NO posee calificación alguna y es de vital importancia para el equipo docente, pues nos permitirá adaptar la dinámica de las clases y tutorías a las necesidades del grupo. 

Esta evaluación fue elaborada por el equipo docente: 

- José Conejeros (<jdconejeros@uc.cl>)
- Fabián Marín (<fabamarinm@gmail.com>)
...
```{r}
sd_question(
  id = "identificacion_correo",
  type = "text",
  label = "Ingrese su correo electrónico (ejemplo: correo@correo.cl)"
)
```
...
Les haremos llegar a cada estudiante sus respuestas. Si tienen dudas o quieren conversar sobre sus respuestas, no duden en contactarnos.
